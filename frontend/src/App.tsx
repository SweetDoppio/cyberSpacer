            ...
            <header className="relative z-10 px-6 py-4">
                <nav className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <a href="#courses" className="text-gray-300 hover:text-[#DBA64A] transition-colors">
                            Courses
                        </a>
                        <a href="#about" className="text-gray-300 hover:text-[#DBA64A] transition-colors">
                            About
                        </a>
                        <a href="#pricing" className="text-gray-300 hover:text-[#DBA64A] transition-colors">
                            Pricing
                        </a>
                        <Button
                            variant="outline"
